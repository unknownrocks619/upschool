...
<div class="container mb-11 mt-8">
    <div class="row gx-0 m-3">
        <div class="col-md-8 col-xl-5 mx-auto border p-5">
            <x-flash></x-flash>
            <!-- Login -->
            <h2 class="mb-6" style="color: #242254;font-weight:bold">Change Your Password</h2>

            <!-- Form Login -->
            <form id="resetPasswordForm" action="{{ route('frontend.user.reset.confirm',[encrypt($user->id)]) }}" method="post" class="mb-5">
                @csrf
                @google_captcha()
                <!-- Email -->
                <div class="form-group mb-3">
                    ...
                    <input type="email" name="email" value="{{old('email',$user->email)}}" type="text " class="form-control" id="email" placeholder="Eg: johndoe@example.com">
                </div>
                ...
                <div class="form-group mb-3">
                    ...
                    <input name="password_confirmation" value="{{ old('password_confirmation') }}" type="password" class="form-control" id="password" placeholder="**********">
                </div>
