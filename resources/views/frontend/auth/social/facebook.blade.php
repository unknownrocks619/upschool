                    ...
                    <div class="col-md-12">
                        <div class="bg-white pt-3 ps-5 dynamic-padding" style="height:100%">
                            ...
                            <div class="row me-5 mt-3">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="first_name" class="mb-2">Would you like to register for a FREE Canva for Education account?
                                            <sup class="text-danger">*</sup>
                                        </label>
                                ...
                                <div class="col-md-12 mt-3 canva-term">
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-10">
                                                <label for="canva_free" class="mb-2">I acknowledge that should I not wish to have my details visible to other users, I can instead sign up for free Canva basic <a href="https://canva.com" target="_blank" style="color:#242254;font-family:'Inter'">here</a>.
                                                    <sup class="text-danger">*</sup>
                                                </label>
