                            ...
                            <table role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px" width="100%" cellspacing="0" cellpadding="0">
                              ...
                              <tr>
                                <td style="padding:0;Margin:0;padding-top:20px" align="left">
                                  ...
                                  <p style="font-family:arial, 'helvetica neue', helvetica, sans-serif">Before you start using your account, we require you to set your password. Please click the link below:</p><a href="{{ $verificationUrl }}" style="font-family:arial, 'helvetica neue', helvetica, sans-serif">[reset_pass_url]</a>
