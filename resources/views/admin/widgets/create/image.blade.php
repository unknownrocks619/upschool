        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <select name="layout" id="layout" class="form-control">
                    <option value="background" @if(old('layout')=="step" ) selected @endif>Background</option>
                    <option value="right_align_image" @if(old('layout')=="foldable" ) selected @endif>Right Align Image</option>
                    <option value="left_align_image" @if(old('layout')=="foldable" ) selected @endif>Left Align Image</option>
                    <option value="alternate" @if(old('layout')=="foldable" ) selected @endif>Alternate Align Image</option>
