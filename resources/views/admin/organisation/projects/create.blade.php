<x-admin-layout>
    ...
    <form action="{{ route('admin.org.org.project.store',$organisation->id) }}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <a href="{{ route('admin.org.org.project.list',$organisation->id) }}" class="btn btn-primary mb-3">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control border border-primary" name="title" id="title" class="form-control" value="{{ old('title') }}">
                                @error('title')
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input value="{{ old('genre') }}" type="text" name="genre" id="genre" class="form-control">
                            </div>
                        </div>
                    </div>
