<x-admin-layout>
    ...
    <div class="col-md-12">
        ...
        <form action="{{ route('admin.org.org.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="url" placeholder="https://vimeo.com/42345352 or https://youtube.com/watch?v=sdl654564sdf" name="video_banner" id="video_banner" class="form-control" />
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-footer">
                    <div class="row">
                        <div class="col-md-6">
                            <button type="submit" class="btn btn-primary">Create New Organisation</button>
                        </div>
                    </div>
                </div>
            </div>
