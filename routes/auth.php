...
Route::middleware('guest')->group(function () {
    ...
    Route::post("/verify-email", [RegisteredUserController::class, "emailCheck"])
        ->name("email_verify");
    ...
    Route::post('register/facebook', [RegisteredUserController::class, "facebookCreate"])->name('facebook-register');
